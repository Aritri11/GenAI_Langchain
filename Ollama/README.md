...
3. Running models interactively
...
5. Using models with images in CLI
...
6. Introspection and tuning from CLI
...
8. Parameters and system prompt in code
...
12. Other Python helper methods
